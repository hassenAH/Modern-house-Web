    ...
    <div class="block w-full overflow-x-auto">
      ...
      <table class="items-center w-full bg-transparent border-collapse">
        ...
        <tr v-for="p in Request" :key="p._id">
          ...
          <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 blue-link">
            <router-link :to="{ name: 'DetailsAdmin', params: { modelUrl: p.link }}" target="_blank">3D Object </router-link>
          </td>
